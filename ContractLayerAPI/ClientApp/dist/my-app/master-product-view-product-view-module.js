...
var ProductMasterComponent = /** @class */ (function () {
    function ProductMasterComponent(router, formBuilder, http, config, dialog) {
        var _this = this;
        this.router = router;
            ...
            },
            {
                ...
                cellRenderer: function (params) {
                    ...
                    newTH.onclick = function () {
                        var ref = _this.dialog.open(_product_master_product_master_component__WEBPACK_IMPORTED_MODULE_7__["ProductMasterComponent"], { data: params.data, modalConfig: { title: 'Add/Edit Product Master' } });
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.setData = function (productData) {
