...
var EnquiryMasterComponent = /** @class */ (function () {
    function EnquiryMasterComponent(router, formBuilder, http, config, dialog, locationService, cusotmerservice) {
        var _this = this;
        this.router = router;
        ...
        this.setDataForEdit = function () {
            ...
            var enquiryForm = _this.config.data;
            enquiryForm.Date = (moment__WEBPACK_IMPORTED_MODULE_10__(_this.config.data.Date).toDate());
            enquiryForm.RemindDate = (moment__WEBPACK_IMPORTED_MODULE_10__(_this.config.data.RemindDate).toDate());
    ...
    EnquiryMasterComponent.prototype.getLocation = function (id) {
        var _this = this;
        this.locationService.getLocationByID(id).subscribe(function (location) {
            _this.enquiryForm.patchValue({ Location: location });
        });
    };
    EnquiryMasterComponent.prototype.searchLocation = function (event) {
        var _this = this;
...
var EnquiryViewComponent = /** @class */ (function () {
    function EnquiryViewComponent(router, http, enquiryService, dialog) {
        ...
        this.columnDefs = [
            ...
            //},
            {
                headerName: 'Edit', valueFormatter: function () { return 'Edit'; }, 'width': 80,
