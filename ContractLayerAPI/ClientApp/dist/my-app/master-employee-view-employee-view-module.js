...
var EmployeeInfoComponent = /** @class */ (function () {
    function EmployeeInfoComponent(router, formBuilder, http, config, dialog) {
        var _this = this;
        this.router = router;
