...
/* harmony import */ var _master_employee_view_employee_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../master/employee-view/employee.service */ "./src/app/master/employee-view/employee.service.ts");
...
var BookingDetailsComponent = /** @class */ (function () {
    function BookingDetailsComponent(router, formBuilder, http, bookingService, config, dialog, locationService, cusotmerService, planService, employeeService) {
        var _this = this;
        this.router = router;
        ...
        this.setDataForEdit = function () {
            ...
            var bookingdetailsForm = _this.config.data;
            bookingdetailsForm.BookingDate = moment__WEBPACK_IMPORTED_MODULE_11__(_this.config.data.BookingDate).toDate();
    ...
    BookingDetailsComponent.prototype.getEmployee = function (id) {
        var _this = this;
        this.employeeService.getEmployeeByID(id).subscribe(function (employee) {
            _this.bookingdetailsForm.patchValue({ Employee: employee });
        });
    };
    BookingDetailsComponent.prototype.searchEmployee = function (event) {
        var _this = this;
        this.employeeService.searchEmployee(event.query).subscribe(function (data) {
            _this.employeeList = data;
        });
    };
    BookingDetailsComponent.prototype.getLocation = function (id) {
        var _this = this;
        this.locationService.getLocationByID(id).subscribe(function (location) {
            _this.bookingdetailsForm.patchValue({ Location: location });
        });
    };
    BookingDetailsComponent.prototype.getCustomer = function (id) {
        var _this = this;
        this.cusotmerService.getCustomerByID(id).subscribe(function (customer) {
            _this.bookingdetailsForm.patchValue({ Customer: customer });
        });
    };
    BookingDetailsComponent.prototype.getPlan = function (id) {
        var _this = this;
        this.planService.getPlanByID(id).subscribe(function (plan) {
            _this.bookingdetailsForm.patchValue({ Plan: plan });
        });
    };
    ...
    BookingDetailsComponent.prototype.searchLocation = function (event) {
        var _this = this;
        this.bookingService.searchLocation(event.query).subscribe(function (data) {
    ...
    BookingDetailsComponent.prototype.saveBookingDetails = function () {
        var _this = this;
        var booking = this.bookingdetailsForm.value;
        ...
        this.bookingService.saveBookingDetails(booking, this.isEditable).subscribe(function (booking) {
...
var BookingService = /** @class */ (function () {
    ...
    BookingService.prototype.searchLocation = function (searchString) {
