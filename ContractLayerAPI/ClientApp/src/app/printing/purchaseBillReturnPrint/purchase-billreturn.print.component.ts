...
@Component({
  ...
  templateUrl: './purchase-billreturn.print.component.html',
  styleUrls: ['./purchase-billreturn.print.component.css']
})
export class PurchaseBillReturnPrintComponent implements OnInit {
  ...
  getAllPurchasebillmastedetails() {
    this.productService.getAllPurchasebillreturnmastedetails(this.PurchaseBillMaster).subscribe((response) => {
